...
class MyCustomViewController: DataViewController<Screen0DSItem> {
	...
	var titleLabel1Button: UIButton!
	...
	override func viewDidLoad() {
		...
		titleLabel1Button = createButton(Images.email)
        addSubview(titleLabel1Button)
	...
	func setupConstraints() {
        ...
        let views:[String: UIView] = [
			...
			"titleLabel1Button": titleLabel1Button,
        ...
        contentConstraints.appendContentsOf(NSLayoutConstraint.constraintsWithVisualFormat("H:|-margin-[titleLabel1]-margin-[titleLabel1Button(buttonSize)]-margin-|",
            options: .DirectionLeadingToTrailing,
            metrics: metrics,
            views: views))
		
		titleLabel1Button.translatesAutoresizingMaskIntoConstraints = false
        contentConstraints.appendContentsOf(NSLayoutConstraint.constraintsWithVisualFormat("V:[titleLabel1Button(buttonSize)]",
            options: .DirectionLeadingToTrailing,
            metrics: metrics,
            views: views))
		
		contentConstraints.append(NSLayoutConstraint(item: titleLabel1Button,
            attribute: .CenterY,
            relatedBy: .Equal,
            toItem: titleLabel1,
            attribute: .CenterY,
...
extension MyCustomViewController: DataResponse {
    ...
    func success() {
		...
		setAction(MailAction(recipient: item?.name), view: titleLabel1Button)
